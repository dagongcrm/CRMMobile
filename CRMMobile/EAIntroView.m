...
//    [self.skipButton setTitle:NSLocalizedString(@"马上体验", nil) forState:UIControlStateNormal];
//    [self.skipButton setBackgroundColor:[UIColor orangeColor]];
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    if(self.currentPageIndex>0){
        ...
        self.skipButton = [[UIButton alloc] initWithFrame:CGRectMake(self.scrollView.frame.size.width-220, self.pageControl.frame.origin.y-20, 120, self.pageControl.frame.size.height+20)];
